    ...
    return (
        <div style={{padding:20}}>
            <Grid container spacing={5}>
                <Grid item sm={4} style={{background:'#79bdf2',display:'flex'}} justify="center" alignItems="center">
                ...
                <Grid item sm={4} style={{background:'#5b8eb5',display:'flex'}} justify="center" alignItems="center">
                    <Tooltip title="Located in Boulder, CO" placement="top">
                        <RoomIcon style={{color:'#fff'}} />
                    </Tooltip>
                </Grid>
                <Grid item sm={4} style={{background:'#1e2f3d',display:'flex'}} justify="center" alignItems="center">
